 ...
 */
package com.viaversion.fabric.mc1217.mixin.gui.client;
...
public class MixinOnlineServerEntry {
    ...
    @Redirect(method = "render", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/gui/GuiGraphics;setTooltipForNextFrame(Lnet/minecraft/network/chat/Component;II)V"))
