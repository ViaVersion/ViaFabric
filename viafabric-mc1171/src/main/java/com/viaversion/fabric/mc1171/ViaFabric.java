 ...
 */
package com.viaversion.fabric.mc1171;
...
import com.viaversion.fabric.mc1171.commands.ViaFabricCommandHandler;
import com.viaversion.fabric.mc1171.platform.FabricPlatform;
import com.viaversion.fabric.mc1171.platform.ViaFabricPlatformLoader;
import com.viaversion.fabric.mc1171.protocol.ViaFabricProtocol;
...
public class ViaFabric implements ModInitializer {
    ...
    public static ViaFabricConfig config;
        ...
        return LiteralArgumentBuilder.<S>literal(commandName)
            .then(
                RequiredArgumentBuilder
                    ...
                    .executes(((ViaFabricCommandHandler) Via.getManager().getCommandHandler())::execute)
                    .suggests(((ViaFabricCommandHandler) Via.getManager().getCommandHandler())::suggestion)
            )
            .executes(((ViaFabricCommandHandler) Via.getManager().getCommandHandler())::execute);
    }
    ...
    public void onInitialize() {
        ...
        Via.init(ViaManagerImpl.builder()
            ...
            .loader(new ViaFabricPlatformLoader())
            .commandHandler(new ViaFabricCommandHandler())
        ...
        config = new ViaFabricConfig(FabricLoader.getInstance().getConfigDir().resolve("ViaFabric")
