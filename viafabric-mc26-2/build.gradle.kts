dependencies {
    ...
    implementation(fabricApi.module("fabric-api-base", "0.152.1+26.2"))
    implementation(fabricApi.module("fabric-resource-loader-v0", "0.152.1+26.2"))
    implementation(fabricApi.module("fabric-command-api-v2", "0.152.1+26.2"))
