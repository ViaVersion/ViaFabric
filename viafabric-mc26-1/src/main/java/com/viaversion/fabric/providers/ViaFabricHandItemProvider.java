 ...
 */
package com.viaversion.fabric.providers;
...
public class ViaFabricHandItemProvider extends HandItemProvider {
    ...
    public void registerClientTick() {
        try {
            ClientTickEvents.END_LEVEL_TICK.register(clientWorld -> tickClient());
